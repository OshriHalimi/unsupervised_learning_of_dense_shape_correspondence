...
### LICENSE.txt
**Important Note:** 
The license is granted only for the code and not for the data. The data we used belongs to MPI-Faust project and the preprocessed models are available here only to make the paper reproduction more easy.
...
Note that you should edit the indices of the test pair you wish to visualize in rows: 7,8 and 10. The result should look similar to this:
<p align="center">
...
<p align="center">
  <img src="https://github.com/OshriHalimi/unsupervised_learning_of_dense_shape_correspondence/blob/master/inter_geo.PNG" width="400" />
</p>
